...
import com.codeworld.fc.search.client.impl.MerchantClientFallBack;
...
@FeignClient(name = "codeworld-cloud-merchant",fallbackFactory = MerchantClientFallBack.class)
